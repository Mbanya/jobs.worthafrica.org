    ...
    var a = function (e, t) {
        ...
        if (v = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7, v && (h.$ = v, h.container = v(e), 0 !== h.container.length)) {
            ...
            h.container[0].swiper = h, h.container.data("swiper", h), h.classNames.push("swiper-container-" + h.params.direction), h.params.freeMode && h.classNames.push("swiper-container-free-mode"), h.support.flexbox || (h.classNames.push("swiper-container-no-flexbox"), h.params.slidesPerColumn = 1), (h.params.parallax || h.params.watchSlidesVisibility) && (h.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(h.params.effect) >= 0 && (h.support.transforms3d ? (h.params.watchSlidesProgress = !0, h.classNames.push("swiper-container-3d")) : h.params.effect = "slide"), "slide" !== h.params.effect && h.classNames.push("swiper-container-" + h.params.effect), "cube" === h.params.effect && (h.params.resistanceRatio = 0, h.params.slidesPerView = 1, h.params.slidesPerColumn = 1, h.params.slidesPerGroup = 1, h.params.centeredSlides = !1, h.params.spaceBetween = 0, h.params.virtualTranslate = !0, h.params.setWrapperSize = !1), "fade" === h.params.effect && (h.params.slidesPerView = 1, h.params.slidesPerColumn = 1, h.params.slidesPerGroup = 1, h.params.watchSlidesProgress = !0, h.params.spaceBetween = 0, "undefined" == typeof c && (h.params.virtualTranslate = !0)), h.params.grabCursor && h.support.touch && (h.params.grabCursor = !1), h.wrapper = h.container.children("." + h.params.wrapperClass), h.params.pagination && (h.paginationContainer = v(h.params.pagination), h.params.paginationClickable && h.paginationContainer.addClass("swiper-pagination-clickable")), h.rtl = s() && ("rtl" === h.container[0].dir.toLowerCase() || "rtl" === h.container.css("direction")), h.rtl && h.classNames.push("swiper-container-rtl"), h.rtl && (h.wrongRTL = "-webkit-box" === h.wrapper.css("display")), h.params.slidesPerColumn > 1 && h.classNames.push("swiper-container-multirow"), h.device.android && h.classNames.push("swiper-container-android"), h.container.addClass(h.classNames.join(" ")), h.translate = 0, h.progress = 0, h.velocity = 0, h.lockSwipeToNext = function () {
                ...
                if ("undefined" == typeof e && (e = h.translate || 0), 0 !== h.slides.length) {
                    ...
                    for (var t = 0; t < h.slides.length; t++) {
                        var r = h.slides[t], i = h.params.centeredSlides === !0 ? r.swiperSlideSize / 2 : 0,
                            n = (a - r.swiperSlideOffset - i) / (r.swiperSlideSize + h.params.spaceBetween);
                        if (h.params.watchSlidesVisibility) {
                            var o = -(a - r.swiperSlideOffset - i), l = o + h.slidesSizesGrid[t],
            ...
            window.navigator.pointerEnabled ? g = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (g = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), h.touchEvents = {
                ...
                var a = e ? "off" : "on", s = e ? "removeEventListener" : "addEventListener",
                    r = "container" === h.params.touchEventsTarget ? h.container[0] : h.wrapper[0],
                    i = h.support.touch ? r : document, n = h.params.nested ? !0 : !1;
            ...
            var w, y, b, x, T, S, C, M, z, P = "input, select, textarea, button", E = Date.now(), I = [];
            ...
            if (h.onTouchStart = function (e) {
                    ...
                    if (e.originalEvent && (e = e.originalEvent), h.emit("onTouchEnd", h, e), w) {
                        ...
                        if (h.allowClick && (h.updateClickedSlide(e), h.emit("onTap", h, e), 300 > t && a - E > 300 && (M && clearTimeout(M), M = setTimeout(function () {
                            ...
                            }, 300)), 300 > t && 300 > a - E && (M && clearTimeout(M), h.emit("onDoubleTap", h, e))), E = Date.now(), setTimeout(function () {
                    ...
                    "undefined" == typeof e && (e = !0), h.lazy && h.lazy.onTransitionStart(), e && (h.emit("onTransitionStart", h), h.activeIndex !== h.previousIndex && (h.emit("onSlideChangeStart", h), h.animateReset(h), h.animate(h), h.headerAlt(h)))
                }, h.onTransitionEnd = function (e) {
                    h.animating = !1, h.setWrapperTransition(0), "undefined" == typeof e && (e = !0), h.lazy && h.lazy.onTransitionEnd(), e && (h.emit("onTransitionEnd", h), h.activeIndex !== h.previousIndex && (h.emit("onSlideChangeEnd", h), h.headerAlt(h))), h.params.hashnav && h.hashnav && h.hashnav.setHash()
                    ...
                    var a = v(window).width();
                    v(e.slides[e.activeIndex]).find("[data-pages-animation=custom]").each(function () {
                        function e() {
                            return null != d.vlgAttr ? (null != d.vlgStart && null != d.vlgEnd && (o[d.vlgAttr] = [d.vlgStart, d.vlgEnd]), l.delay = null != d.vlgDelay ? d.vlgDelay : 0, l.duration = null != d.vlgDuration ? d.vlgDuration : 400, null != d.vlgEasing ? l.easing = d.vlgEasing : "", l.visibility = "visible", l.mobileHA = !0, n.velocity(o, l), !0) : !1
                        }

                        function t() {
                            return null != d.lgAttr ? (null != d.lgStart && null != d.lgEnd && (o[d.lgAttr] = [d.lgStart, d.lgEnd]), l.delay = null != d.lgDelay ? d.lgDelay : 0, l.duration = null != d.lgDuration ? d.lgDuration : 400, null != d.lgEasing ? l.easing = d.lgEasing : "", l.visibility = "visible", l.mobileHA = !0, n.velocity(o, l), !0) : !1
                        }

                        function s() {
                            return null != d.mdAttr ? (null != d.mdStart && null != d.mdEnd && (o[d.mdAttr] = [d.mdStart, d.mdEnd]), l.delay = null != d.mdDelay ? d.mdDelay : 0, l.duration = null != d.mdDuration ? d.mdDuration : 400, null != d.mdEasing ? l.easing = d.mdEasing : "", l.visibility = "visible", l.mobileHA = !0, n.velocity(o, l), !0) : !1
                        }

                        function r() {
                            return null != d.smAttr ? (null != d.smStart && null != d.smEnd && (o[d.smAttr] = [d.smStart, d.smEnd]), l.delay = null != d.smDelay ? d.smDelay : 0, l.duration = null != d.smDuration ? d.smDuration : 400, null != d.smEasing ? l.easing = d.smEasing : "", l.visibility = "visible", l.mobileHA = !0, n.velocity(o, l), !0) : !1
                        }

                        function i() {
                            null != d.attr && (null != d.start && null != d.end && (o[d.attr] = [d.start, d.end]), l.delay = null != d.delay ? d.delay : 0, l.duration = null != d.duration ? d.duration : 400, null != d.easing ? l.easing = d.easing : "", l.visibility = "visible", l.mobileHA = !0, n.velocity(o, l))
                        }

                        var n = v(this), o = {}, l = {}, d = n.data();
                        a >= 1800 && (e() || i()), 1800 >= a && a > 1024 ? t() || i() : 1024 >= a && a > 768 ? s() || i() : 768 >= a && (r() || i())
                    }), v(e.slides[e.activeIndex]).find("[data-pages-animation=standard]").each(function () {
                        var e = v(this), a = {}, t = e.data();
                        null != t.type && (a.delay = null != t.delay ? t.delay : 0, a.duration = null != t.duration ? t.duration : 400, a.stagger = null != t.stagger ? t.stagger : !1, a.drag = null != t.drag ? t.drag : !1, a.visibility = "visible", a.mobileHA = !0, e.velocity(t.type, a))
                    })
                }, h.animateReset = function (e) {
                    var a = v(e.slides[e.previousIndex]).find("[data-pages-animation=custom], [data-pages-animation=standard]");
                    0 !== a.length && (a.stop(), a.velocity({opacity: [0, 1]}, {
                        duration: 300, complete: function (e) {
                            v(e).removeAttr("style").css("visibility", "hidden")
                        }
                    }))
                }, h.headerAlt = function (e) {
                    null != v(e.slides[e.activeIndex]).attr("data-pages-header") ? v("[data-pages=header]").addClass("alternate") : v("[data-pages=header]").removeClass("alternate")
                }, h.effects = {
                    fade: {
                        ...
                        setTranslate: function () {
                            ...
                            if (h.wrapper.css({
                                ...
                                var f = Math.abs(a) - 90 * Math.floor(Math.abs(a) / 90),
                                    ...
                                    w = h.params.cube.shadowScale, y = h.params.cube.shadowScale / g,
                        ...
                        setTranslate: function () {
                            for (var e = h.translate, a = s() ? -e + h.width / 2 : -e + h.height / 2, t = s() ? h.params.coverflow.rotate : -h.params.coverflow.rotate, r = h.params.coverflow.depth, i = 0, n = h.slides.length; n > i; i++) {
                                var o = h.slides.eq(i), l = h.slidesSizesGrid[i], d = o[0].swiperSlideOffset,
                                    p = (a - d - l / 2) / l * h.params.coverflow.modifier, u = s() ? t * p : 0,
            ...
            for (var A in h.plugins) {
                var L = h.plugins[A](h, h.params[A]);
                L && h._plugins.push(L)
            }
