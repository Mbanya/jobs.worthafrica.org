...
@section('cover')
    ...
    <header class="page-title pt-large pt-dark pt-plax-lg-dark1" data-stellar-background-ratio="0.2">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="small-12 medium-12 large-5 columns p-t-20">
                    ...
                    <div class="p-t-15 p-b-25">
                        <a class="btn-block btn btn-solid" href="{{route('seeker_medics')}}">Get Started</a>
                    </div>
                </div>
                ...
                <div class="small-12 medium-12 large-5 columns p-t-20">
                    ...
                    <div class="p-t-15 p-b-25">
                        <a class="btn-block btn btn-solid" href="{{route('hire_medics')}}">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
