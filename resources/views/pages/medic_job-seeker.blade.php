...
@section('cover')
    ...
    <div id="home" class="animated-hero animated-hero5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="img-horz-center">
                        <img class="img-responsive" src="{{url('images/hero/group-happy-african-american-medical-team-thumbs-up-30059275.jpg')}}" alt="work with us">
                    </div>
                </div>
            </div>
        </div>
