        ...
        <div id="signup-choice">
            <div class="row">
                <div class="small-12 medium-12 large-5 columns p-t-20">
                    <h1>Employer Registration.<br> </h1>
                    <h4>Save time when hiring</h4>
                    <span class="fa fa-building-o p-t-15 p-b-15" style="font-size: 170px;"></span>
                    <div class="p-t-15 p-b-25">
                        <a class="btn-block btn btn-solid" href="{{route('organisation_register')}}">Get Started</a>
                    </div>
                </div>
                ...
                <div class="small-12 medium-12 large-5 columns p-t-20">
                    ...
                    <h4>Get connected to your dream job</h4>
                    <i class="fa fa-user  p-t-15 p-b-15" style="font-size: 170px" aria-hidden="true"></i>
                    <div class="p-t-15 p-b-25">
                        <a class="btn-block btn btn-solid" href="{{route('register')}}">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
