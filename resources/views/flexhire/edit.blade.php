                    ...
                    <div class="col-md-offset-1 col-md-10">
                        <div class="form-wrapper">
                            <div class="form-content">
                                <h3 class="form-header">Edit Flex Hire Post</h3>
                                @if(count($errors))
                                ...
                                @endif
                                <form action="/flexhire/{{$flexhire->id}}" role="form" method="POST">
                                    {{method_field('PUT')}}
                                {{ csrf_field() }}
                                <h5></h5>
                                    <ol>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 no-gap-right {{ $errors->has('organisation_name') ? 'has-error' : '' }}">
                                                <input type="text"  class="form-control" name="organisation_name" value="{{$flexhire->organisation_name}}" placeholder=" Organisation Name" required autofocus>
                                            ...
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('organisation_size') ? 'has-error' : '' }}" >
                                                <select name="organisation_size" class="form-control" id="select-form">
                                                    <option selected disabled>{{$flexhire->organisation_size}}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('organisation_type') ? 'has-error' : '' }}" >
                                                <select name="organisation_type" class="form-control" id="select-form">
                                                    <option selected disabled>{{$flexhire->organisation_type}}</option>
                                            ...
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('Physical_Address') ? 'has-error' : '' }}" >
                                                <input type="text" name="Physical_Address"value="{{$flexhire->Physical_Address}}"  class="form-control" placeholder="Physical Address " required autofocus>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 no-gap-right {{ $errors->has('email') ? 'has-error' : '' }}">
                                                <input type="email"  name="email" class="form-control" value="{{$flexhire->email}}" placeholder="Enter contact email" required autofocus>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('key_qualification') ? 'has-error' : '' }}">
                                                <select name="key_qualification" class="form-control" id="select-form">
                                                    <option selected disabled>{{$flexhire->key_qualification}}</option>
                                            ...
                                            <div class="form-group col-md-10 no-gap-right{{ $errors->has('Qualification_Description') ? 'has-error' : '' }}">
                                                <textarea class="form-control" name=" Qualification_Description" id="txt-forms" rows="10" placeholder="Do candidates need education in a specific subject (e.g. diploma or degree in marketing or communication)? If so, please indicate further here.">{{$flexhire->Qualification_Description}}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-10 no-gap-right{{ $errors->has('experience') ? 'has-error' : '' }}">
                                                <select name="experience" class="form-control" id="select-form">
                                                    <option selected disabled>{{$flexhire->experience}}</option>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-10 no-gap-right{{ $errors->has('Responsibilities') ? 'has-error' : '' }}">
                                                <textarea class="form-control" name="Responsibilities" id="txt-forms" rows="8" placeholder="What are the tasks that the person will be responsible for on a day to day basis? (e.g. Plan weekly travel arrangements for the CEO, clean up viruses from office computers)">{{$flexhire->Responsibilities}}</textarea>
                                            ...
                                            <div class="form-group col-md-10 no-gap-right{{ $errors->has('skills') ? 'has-error' : '' }}">
                                                <textarea class="form-control" name="skills" rows="7" placeholder="What are the key skills required for this job Example (Software Development, Google Digital Marketing...etc)">{{$flexhire->skills}} </textarea>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-5 no-gap-right{{ $errors->has('minSal') ? 'has-error' : '' }}">
                                                    <input type="number" class="form-control"name="minSal" value="{{$flexhire->minSal}}" placeholder="Minimum salary">
                                                ...
                                                <div class="form-group col-md-5 no-gap-right{{ $errors->has('maxSal') ? 'has-error' : '' }}">
                                                    <input type="number" class="form-control" name="maxSal" value="{{$flexhire->maxSal}}" placeholder="Maximum salary ">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-10 no-gap-right{{ $errors->has('Frequency_Rate') ? 'has-error' : '' }}">
                                                    <select name=" Frequency_Rate" class="form-control" id="select-form">
                                                        <option selected disabled>{{$flexhire->Frequency_Rate}}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-5 no-gap-right{{ $errors->has('start_date') ? 'has-error' : '' }}">
                                                    <input class="form-control" type="date" value="{{$flexhire->start_date}}" name="start_date" id="date-form">
                                                ...
                                                <div class="form-group col-md-5 no-gap-right{{ $errors->has('end_date') ? 'has-error' : '' }}">
                                                    <input class="form-control" type="date" name="end_date" value="{{$flexhire->end_date}}" id="date-form">
                                                    <span class="text-danger">{{ $errors->first('end_date') }}</span>
                                                    <label for="date-form">Expected End Date</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" class="btn pull-left" value="Update Flex Job">
                                            </div>
                                        </div>
                                    </ol>
                                </form>
