            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-offset-3">
                        <h2 class="text-master ">Your Flex Hire Posts</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p class="t-description">{{$flexhire->key_qualification}}</p><br>
                        <p class="t-description">{{$flexhire->Qualification_Description}}</p>
                        <hr>
                        <span><b>Responsibilities include</b></span>
                        <p class="t-description">{{$flexhire->Responsibilities}}</p> <br>

                        <span><b>Skills Required for the Job</b></span>
                        <p class="t-description">{{$flexhire->skills}}</p>
                    </div>

                </div>
                <div class="col-md-6" style="padding-bottom: 10%">
                    <a href="{{url('/flexhire')}}" class="btn btn-block pull-center">Back</a>
                </div>
            </div>
