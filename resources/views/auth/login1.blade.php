...
@section('content')
    <!-- ========== Login From ========== -->
    <section class="container no-gap-right p-b-50 p-t-75">
        <div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <p style="color: black">JOBS FILTER is a total break through! In 3 simple steps
                            ...
                            <a href="#How it works" class="link">Learn more</a>
                        </div>
                            ...
                            <div class="panel-group" id="login-accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-login">
                                                ...
                                                <form id="login-form" role="form" action="{{url('filter_login')}}" method="POST">
                                                    @if(session('error'))
                                ...
                                <div class="panel bottom-panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingTwo">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button"  href="{{route('jobfilterregister')}}" >
                                                Register account
                                            </a>
                                        </h4>
                                    </div>
