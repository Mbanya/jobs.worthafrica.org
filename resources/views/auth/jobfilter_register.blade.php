                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <div class="form-register">
                                            <form action="{{ route('jobfilterregister') }}" role="form" method="POST">
                                                {{ csrf_field() }}
                                                @if(session('error'))
                                            ...
                                            <!-- Organisation  Name -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12 no-gap-right">
                                                        <select name="hires" id="hires" class="form-control">
                                                            <option selected disabled value="">Select one</option>
                                                            <option value="10 and Below">10 and below</option>
                                                            <option value="10-30">between 10-30</option>
                                                            <option value="10 and above">30 and above</option>
                                                        </select>
                                                        <label>Number of Hires through your organisation per year</label>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <!-- Password -->
                                                    <div class="form-group col-md-12 no-gap-right">
                                                        <input type="text" id="avg_time" name="avg_time"  class="form-control" placeholder="Example: 1 hr " value="{{old('avg_time')}}" required autofocus>
                                                        <label for="avg_time">Avg time it takes per application (hrs)</label>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-12 no-gap-right">
                                                        <input type="number" id="avg_cvs" name="avg_cvs" class="form-control" value="{{old('avg_cvs')}}" placeholder="Example: 300" required autofocus>
                                                        <label for="avg_cvs">Avg number of CVs you handle per year</label>
                                                    </div>
                                                </div>
                                                <!-- Submit -->
