                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
                                                        ...
                                                        <tr>
                                                            <td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                                ...
                                                                <h3 style="color: #666; display: block; font-family: Helvetica; font-size: 16px; font-style: normal; font-weight: normal; line-height: 110%; letter-spacing: normal; margin: 0; margin-bottom: 9px; text-align: left"><strong><em>New Application From {{ $senderFullname }}</em></strong></h3>
                                                                <p>{{ $senderFullname }} has applied for <a href="{{ $appliedForLink }}">{{ $appliedFor }}</a></p>
                                                                <ul>
                                                                    <li>Fullname: {{ $senderFullname }}</li>
                                                                    <li>Email: {{ $senderEmail }}</li>
                                                                    <li>Phone: {{ $senderPhone }}</li>
                                                                </ul>
                                                                <p style="margin: 0; padding-bottom: 0">Your can reply to this email to contact to sender.​</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
