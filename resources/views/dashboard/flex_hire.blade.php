...
@if(Sentinel::getUser()->inRole('organisation'))
    <title>{{Sentinel::getUser()->organisation_name. "'s"}} Flex Hiring</title>
 @elseif(Sentinel::getUser()->inRole('individual'))
    <title>{{Sentinel::getUser()->first_name. "'s'"}}Flex Profile</title>
    @else
    <title>{{Sentinel::getUser()->organisation_name. "'s"}} Flex Hiring</title>
    @endif
@stop
            ...
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    @if(Sentinel::getUser()->inRole('organisation'))
                        ...
                        <li class="active"><a href="{{route('flexhire')}}" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-search"></span><p>Flex Hire</p></a></li>
                    @elseif(Sentinel::getUser()->inRole('jobfilter'))
                        <li><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        <li><a href="{{route('jobfilter')}}" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-file"></span><p>Create new Job filter Request</p></a></li>
                        <li ><a href="{{route('findTalent')}}" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-search"></span><p>Find Talent</p></a></li>
                    ...
                    @else
                        ...
                        <li class="active"><a href="{{route('flexhire')}}" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-search"></span><p>Create a Flex Profile</p></a></li>
                ...
                <div class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @elseif(Sentinel::getUser()->inRole('jobfilter'))
                            <li class="active">Flex Hire</li>
                        @else
                            <li class="active">Flex Profile</li>
                        @endif
                    </ol>
                </div>
            </div>
                        ...
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                @endif
                                    @if(Sentinel::getUser()->inRole('individual'))
                                        <form action="POST" action="{{route('jobs.store')}}">
                                            ...
                                            <div class="row m-b-lg">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-12" :class="{'has-error' : errors.has('CV) }">
                                    ...
                                    @else
                                    <form id="Form" method="POST" action="/flexhire">
                                        {{csrf_field()}}
                                                <div class="row m-b-lg">
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="Frequency_Rate"><span class="text-danger">*</span>Mode of Payment</label>
                                                            <select name="Frequency_Rate" class="form-control" id="Frequency_Rate">
                                                                <option selected disabled v-validate.initial="'required'">Mode of payment</option>
                                                        ...
                                                        <div class="form-group col-md-6" :class="{'has-error' : errors.has('end_date')}">
                                                            <label for="end_date"><span class="text-danger">*</span>End Date</label>
                                                            <input type="date" class="form-control datepicker" v-validate.initial="'required|date_format'" name="end_date" id="end_date" placeholder="Expected End Date" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-12">
