    ...
    <header class="page-title pt-large pt-dark pt-plax-lg-dark">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h1>Jobseeker</h1>
                    <span class="subheading">Create Job Profile</span>
                </div>
                    ...
                    <div class="col-md-offset-1 col-md-10">
                        <div class="form-wrapper">
                            <div class="form-content">
                                <h3 class="form-header">Build your Profile</h3>
                                @if(count($errors))
                                ...
                                @endif
                                <form action="/jobs" role="form" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <!-- Organisation  Name -->
                                    <ol>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('skills') ? 'has-error' : '' }}">
                                                <input class="form-control" name="skills"  placeholder="What Skills do you have Eg (Software Development, Google Digital Marketing...etc)">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 no-gap-right{{ $errors->has('cover_letter') ? 'has-error' : '' }}">
                                                <label for="txt-forms">Cover Letter  </label>
